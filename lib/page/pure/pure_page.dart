...
class PurePage extends StatefulWidget {
  const PurePage({super.key, required this.screenType});

  final ScreenType screenType;

  @override
  State<PurePage> createState() => _DesignPageState();
}

class _DesignPageState extends State<PurePage> {
      ...
      child: Padding(
        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              children: [
                Text('Hello World', style: TextStyle(fontSize: 40, fontWeight: FontWeight.w700)),
                SizedBox(width: 20),
                Column(
                  children: [Text('font 40', style: TextStyle(fontSize: 24, fontWeight: FontWeight.w700))],
                ),
              ],
            ),
            SizedBox(height: 20),
  ...
  Column _extraWidgets(BuildContext context) {
    return Column(
      children: [
        // sizeText(context),
        // SizedBox(height: 20),
        Text(longText, style: TextStyle(fontSize: 16, fontWeight: FontWeight.w700)),
        SizedBox(height: 20),
      ],
    );
  }
